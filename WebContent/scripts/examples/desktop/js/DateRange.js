...
Ext.define('Ext.calendar.form.field.DateRange', {
	...
	getFieldConfigs : function() {
		...
		return [me.getStartDateConfig(), me.getStartTimeConfig(),
				me.getDateSeparatorConfig(), me.getEndDateConfig(),
				me.getEndTimeConfig(), me.getAllDayConfig()];
	},
	...
	setValue : function(v) {
		...
		} else if (v['beginTime']) { // object
			this.setDT(v['beginTime'],
					'start');
			if (!this.setDT(v['endTime'],
					'end')) {
				this.setDT(v['beginTime'],
						'end');
			}
